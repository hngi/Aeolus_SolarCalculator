						...
						<div class="col-md-5 mx-auto">
							...
							<form id="xhlogin" class="needs-validation" novalidate autocomplete="off">
								...
								<div class="mt-4">
									...
									<a href="<?php echo $client->createAuthUrl() ?>" class="btn w-100 btn-primary mb-1" style="background-color:#dd4b39;border-color:#dd4b39;color:#fff">Continue with Google</a>
				...
				$.ajax({
					...
					success: function(json){
						if (json.status == false) {
							...
							$('#err-msg').html('<strong>Access Denied:</strong>&nbsp;Incorrect login details. Try again.');
							$('#err-msg').removeClass('d-none');
						}
						if (json.status == true) {
							$('#lgntxt').show();
							$('#spinlgn').addClass('d-none');
							$('#err-msg').html('<strong>Access Granted:</strong>&nbsp;You are now logged in. Redirecting.');
